...
public class Map : MonoBehaviour
{
    ...
    public class Graph
    {
        ...
        */
        ...
        public int CompareDistanceFromEnd(coords c1, coords c2)
        {
            if (this.GetDistanceFromEnd(c1) < this.GetDistanceFromEnd(c2))
            {
                return -1;
            }
            else if (this.GetDistanceFromEnd(c1) == this.GetDistanceFromEnd(c2))
            {
                return 0;
            }
            else
